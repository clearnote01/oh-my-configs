...
" ===== Indentation data =====
    ...
    set showcmd
    set nofoldenable
    autocmd FileType vim,jade,html,javascript,coffee,cucumber setlocal sw=2 sts=2 ts=2 
...
" Run node js
nnoremap ,rn :w<CR>:!node %<CR>
" Run python 
nnoremap ,rp :w<CR>:!python %<CR>
" Run shell
nnoremap <c-j> :w<CR>:!./%<CR>

" For jshint --- javascript
"
nnoremap ,js :w<CR>:!jslint %<CR>
